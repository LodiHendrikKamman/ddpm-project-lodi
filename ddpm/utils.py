...
def load_unet(state_dict_path: str, channels, convs_per_level) -> UNet:
...
def model_name(channel0: int, convs_per_level: int) -> str:
    return f'C0_{channel0}_convs_{convs_per_level}'


def path_name(channel0: int, convs_per_level: int, add_desc="") -> str:
